...
private:
    ...
    RackModulePanel matchingPanel { "Matching Engine" }, micPanel { "Mic Character" };
    RackModulePanel preampPanel { "Preamp Architecture" }, heroPanel { "Aura Magic Control" };
    RackModulePanel compPanel { "Compressor" }, satPanel { "Saturation Amount" };
    RackModulePanel xfmrPanel { "Transformer Weight" }, consolePanel { "Console / Summing" };
    RackModulePanel gluePanel { "Bus Glue" }, eqPanel { "EQ Graph" };
    RackModulePanel widthPanel { "Stereo Width" }, limiterPanel { "Limiter" };
    ...
    PremiumKnob micAmount { "AMT", 0.0, " dB" }, deHarsh { "DEH", 35.0, " %" };
