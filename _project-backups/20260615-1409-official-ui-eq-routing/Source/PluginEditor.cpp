...
void StadiumAuraAudioProcessorEditor::resized()
{
    ...
    auto topBar = bounds.removeFromTop (96);
    auto footerBar = bounds.removeFromBottom (58);
    auto meterBar = bounds.removeFromBottom (88);
    auto eqRow = bounds.removeFromBottom (104);
    auto main = bounds.reduced (0, 4);

    logoTitle.setBounds (topBar.removeFromTop (30).withSizeKeepingCentre (420, 28));
    logoSubtitle.setBounds (topBar.removeFromTop (16).withSizeKeepingCentre (560, 14));
    monitorLabel.setBounds (topBar.removeFromTop (16).reduced (20, 0));
    auto nav = topBar.removeFromTop (28).reduced (40, 0);
    ...
    auto inMeter = main.removeFromLeft (50);
    auto outMeter = main.removeFromRight (50);
    ...
    inputKnob.setBounds (leftArea.removeFromTop (118).withSizeKeepingCentre (104, 104));
    auto toneRow = leftArea.removeFromTop (82);
    layoutKnobRow (toneRow, { &bodyKnob, &presenceKnob, &airKnob });
    auto harmRows = leftArea.removeFromTop (164);
    ...
    auto matchKnobs = leftArea.removeFromTop (72);
    layoutKnobRow (matchKnobs, { &correction, &targetAmount, &badFreq });
    auto micButtons = leftArea.removeFromTop (24);
    hardwareSafe.setBounds (micButtons.removeFromLeft (micButtons.getWidth() / 2).reduced (2));
    ...
    tubeChamber.setBounds (hero.removeFromTop (150).reduced (8, 0));
    hero.removeFromTop (8);
    trackButtons.setBounds (hero.removeFromTop (26).reduced (70, 0));
    hero.removeFromTop (4);
    tubeType.setBounds (hero.removeFromTop (22).reduced (60, 0));
    hero.removeFromTop (6);
    auto auraBlock = hero.removeFromTop (juce::jmin (hero.getHeight() - 54, hero.getWidth() - 36));
    ...
    consoleMode.setBounds (hero.removeFromBottom (24).reduced (40, 0));
    ...
    layoutKnobRow (outputTop, { &mix, &width, &ceiling });
